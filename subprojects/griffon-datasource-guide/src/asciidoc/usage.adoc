...
You may configure multiple named datasources (the default datasource is aplty named `default`) as the following snippet
shows
...
callbacks you may use with this methods: either you work with a `java.sql.DataSource` instance using `{api_datasource_callback}`
...
public class SampleService extends AbstractGriffonService {
    ...
    public String getPersonName(final long id) {
         return dataSourceHandler.withDataSoure(new DataSourceCallback<String>() {
