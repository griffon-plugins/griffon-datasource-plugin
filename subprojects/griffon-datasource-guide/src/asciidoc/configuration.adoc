...
----
dependencies {
    griffon '{groupId}:griffon-datasource-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-datasource-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{groupId}:griffon-datasource-groovy-compile:{project-version}'
}
----
