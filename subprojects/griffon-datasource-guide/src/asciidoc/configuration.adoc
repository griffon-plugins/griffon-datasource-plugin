...
----
dependencies {
    griffon '{project-group}:griffon-datasource-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-datasource-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-datasource-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-datasource-plugin` BOM in your POM file, by placing the following
